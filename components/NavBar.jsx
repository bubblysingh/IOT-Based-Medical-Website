      ...
      <div className='flex items-center gap-4'>
        {token ? (
          <div className='relative group flex items-center cursor-pointer'>
            ...
            <div 
              className='absolute top-full right-0 bg-white shadow-md rounded-md p-2 z-50 min-w-[180px] hidden group-hover:block'
              role="menu"
            >
              <button 
                onClick={() => navigate('my-profile')} 
                className='block w-full py-2 px-4 hover:text-[#4361ee] hover:bg-gray-100 rounded cursor-pointer text-left transition-colors'
                role="menuitem"
              >
                My Profile
              </button>
          ...
          <button 
            ...
            className='px-6 py-2.5 bg-[#4361ee] text-white rounded-full font-medium hover:bg-[#3651d4] transition-colors hidden md:block'
          >
            Create Account
          </button>
        )}
        ...
        <div 
          className={`mobile-menu md:hidden fixed top-0 right-0 h-full w-64 bg-white shadow-lg p-6 z-50 transform transition-transform duration-300 ${showMenu ? 'translate-x-0' : 'translate-x-full'}`}
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <ul className="space-y-4">
            <NavLink to="/" className={({ isActive }) => 
              isActive ? "block w-full py-2 text-[#4361ee]" : "block w-full py-2 hover:text-[#4361ee]"
            }>
              HOME
            </NavLink>
            <NavLink to="/doctors" className={({ isActive }) => 
